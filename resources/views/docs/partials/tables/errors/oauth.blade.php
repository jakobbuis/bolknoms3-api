<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Validating your token produced an invalid response from the authorization server. This is usually an internal error: please contact support. If this were your fault, oauth_token_invalid would have been returned instead.</td>
        </tr>
    </tbody>
</table>
